...
def asv_embedding():
    '''
    Saves the ASV embeddings of DNABERT to a file in the data folder called 'asv_embeddings_dnabert.npy'.
    '''
    ...
    np.save("data/input/asv_embeddings_dnabert.npy", embeddings)
    np.save("data/input/asv_embeddings_ids.npy", table.ids(axis="observation"))
    print(f'DNABERT: ASV embeddings and ids saved.')