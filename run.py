...
from DNABERT.training import train_model as train_model_dnabert
from DNABERT.test import test_model as test_model_dnabert
from DNABERT.plot_auroc_auprc import plot_auroc_auprc as plot_auroc_auprc_dnabert
    ...
    try:
        ...
        if model == 'dnabert':            
            if target in ['training', 'all']:
                ...
                train_model_dnabert(train_fp ='data/input/training_metadata_stool.tsv', large=False, opt_type='adam', hidden_dim=768, num_hidden_layers=5, dropout_rate=0, learning_rate=0.001, beta_1=0.5, beta_2=0.999, weight_decay=0.001)
            if target in ['test', 'all']:
                forehead_predictions = test_model_dnabert('data/input/test_metadata_forehead.tsv', model_fp='trained_models_dnabert/forehead/forehead_best_model.keras')
                inside_floor_predictions = test_model_dnabert('data/input/test_metadata_inside_floor.tsv', model_fp='trained_models_dnabert/inside_floor/inside_floor_best_model.keras')
                stool_predictions = test_model_dnabert('data/input/test_metadata_stool.tsv', model_fp='trained_models_dnabert/stool/stool_best_model.keras')
                nares_predictions = test_model_dnabert('data/input/test_metadata_nares.tsv', model_fp='trained_models_dnabert/nares/nares_best_model.keras')
