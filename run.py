...
if __name__ == "__main__":
    try:
        ...
        if target in ['test','all']:
            forehead_predictions = test_model('data/input/test_metadata_forehead.tsv', model_fp='trained_models_grover/forehead/forehead_best_model.keras')
            inside_floor_predictions = test_model('data/input/test_metadata_inside_floor.tsv', model_fp='trained_models_grover/inside_floor/inside_floor_best_model.keras')
            stool_predictions = test_model('data/input/test_metadata_stool.tsv', model_fp='trained_models_grover/stool/stool_best_model.keras')
            nares_predictions = test_model('data/input/test_metadata_nares.tsv', model_fp='trained_models_grover/nares/nares_best_model.keras')
